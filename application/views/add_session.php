            ...
            <?php endif ?>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <?php $attributes = array('role' => 'form', 'class' => 'form-horizontal style-form'); echo form_open('main/add_session_to_db/' . $client[0]['id'], $attributes); ?>
                      <!-- <form class="form-horizontal style-form" method="get"> -->
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10 col-lg-4">
                                <div class="checkbox">
                                  <label>
                                    <?php echo form_checkbox('completed', 'accept', FALSE); ?>
